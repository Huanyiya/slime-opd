...
class RayTrainGroup:
    ...
    def _reload_rollout_weights_from_disk(self, disk_weight_dir, weight_version):
        ...
        # Version verification is cheap compared with loading a checkpoint and
        # must run in production as well as CI.  Do not start rollout with a
        # mixture of old and new student weights across the eight engines.
