...
def train(
    ...
    for step_id in range(num_steps_per_rollout):
        ...
        if (
            ...
            metric_train_step = accumulated_step_id + 1
            ...
            log_dict["step"] = metric_train_step
            log_dict["train/step"] = metric_train_step
            ...
            logger.info(f"{role_tag}step {metric_train_step}: {log_dict}")
