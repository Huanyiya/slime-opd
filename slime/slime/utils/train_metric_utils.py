...
from slime.utils.metric_utils import add_train_step_metric, compute_train_step_after_rollout, get_metric_train_step
...
def log_perf_data_raw(
    ...
    step = get_metric_train_step(args, fallback=compute_train_step_after_rollout(args, rollout_id))
