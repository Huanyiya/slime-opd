...
class Qwen3_5Bridge(Qwen2MoEBridge):
    ...
    def _build_config(self):
        ...
        # Older SGLang's dense Qwen3.5 compatibility config inherits from
        # Qwen3NextConfig and therefore also exposes default MoE fields.  Use
        # the explicit Qwen3.5 model type instead of attribute presence.
        is_moe = "moe" in str(getattr(text_config, "model_type", "")).lower()
        if is_moe:
            base_kwargs.update(
