...
@pytest.mark.unit
def test_last_boxed_returns_last_complete_when_multiple():
    """The rightmost complete boxed expression is the submitted answer."""
    s = r"first attempt \boxed{wrong}, final \boxed{42}"
    assert last_boxed_only_string(s) == r"\boxed{42}"


@pytest.mark.unit
def test_last_boxed_skips_incomplete_rightmost_box():
    s = r"final answer \boxed{42}, repeated but truncated \boxed{42"
    assert last_boxed_only_string(s) == r"\boxed{42}"
